...
public class ServiceImplAdapter extends PluginAdapter {
    @Override
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        try {
            Template t = new Template(null, new InputStreamReader(this.getClass().getResourceAsStream("/ServiceImpl.ftl")), null);
            String format = String.format("%s%s%s/%s/service/%sServiceImpl.java", System.getProperty("user.dir"), File.separator, targetProject, targetPackageFile, domainObjectName);
