...
public class ControllerAdapter extends PluginAdapter {
    @Override
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        try {
            Template t = new Template(null, new InputStreamReader(this.getClass().getResourceAsStream("/Controller.ftl")), null);
            String format = String.format("%s%s%s/%s/controller/%sController.java", System.getProperty("user.dir"), File.separator, targetProject, targetPackageFile, domainObjectName);
